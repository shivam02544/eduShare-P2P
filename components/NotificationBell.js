  ...
  return (
    <div ref={ref} className="relative">
      <button onClick={handleOpen}
        ...
        {unread > 0 && (
          <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center font-bold animate-fade-in">
            {unread > 9 ? "9+" : unread}
          </span>
        )}
      </button>
